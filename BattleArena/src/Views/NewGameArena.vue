...
<template>
  ...
  <div class="new-game-arena-container flex flex-col items-center h-full pb-4 bg-white dark:bg-gray-900">
        ...
        <section class="flex flex-col justify-around rounded-lg bg-white dark:bg-gray-900">
          <section class="p-4 flex flex-col">
            ...
            <button
              ...
              Apply Filter(s)
              <!--@click="navigateTo('GameArena')">Create Arena -->
...
.new-game-arena-container {
  background-image: url("Photos/locker_room.jpg");

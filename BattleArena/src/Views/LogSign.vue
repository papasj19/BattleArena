<template>
  <main class="flex justify-center items-center flex-col sm:flex-row h-screen" style="background-image: url('Photos/cozy-room.png'); background-size: cover;">
    <div class="p-4">
      ...
      <!-- Sign Up -->
      <div v-if="isSignupModalOpen" class="modal">
        <span @click="closeModal('signup')" class="close" title="Close Modal">&times;</span>
      ...
      <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <div class="clearfix">
              <button type="button" @click="closeModal('signup')" class="cancelbtn">Cancel</button>
            </div>
          </div>
        </form>
      </div>
    ...
    <div class="p-4">
      <button @click="showLoginModal" style="width:auto;">Log In</button>

      <!-- Log In -->
      <div v-if="isLoginModalOpen" class="modal">
        <span @click="closeModal('login')" class="close" title="Close Modal">&times;</span>
        <form class="modal-content" action="/action_page.php">
          <div class="container">
            <section class="bg-transparent dark:bg-transparent"> 
              <div class="flex flex-col items-center justify-center px-6 py-4 mx-auto md:h-screen lg:py-0">      
      <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <div class="clearfix">
              <button type="button" @click="closeModal('login')" class="cancelbtn">Cancel</button>
            </div>
          </div>
        </form>
      </div>
